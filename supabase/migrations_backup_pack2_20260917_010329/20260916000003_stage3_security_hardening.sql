...
CREATE TABLE IF NOT EXISTS public.data_reports (
    ...
    branch_id VARCHAR(80) REFERENCES public.restaurant_branches(id) ON DELETE SET NULL,
...
BEGIN
    ...
    LOOP
        ...
        SELECT 
            COALESCE(bmi.branch_price_tzs, mi.price_tzs),
            mi.name_en,
...
ALTER TABLE public.branch_menu_items ADD CONSTRAINT chk_branch_menu_items_price_nonneg CHECK (branch_price_tzs IS NULL OR branch_price_tzs >= 0);
